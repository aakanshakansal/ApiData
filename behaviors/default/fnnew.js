...
class LightPawn extends PawnBehavior {
  setup() {
    ...
    // // const handleObjectInteraction = (clickedObject) => {
    // //   let isTile = false;
    // //   let isRack = false;
    // //   let isObject = false;
    ...
    //   tileInfo.style.display = "none";
    // };
    // Add this function to check API response
    ...
    //   if (apiValue === 1) {
    //     // Only show info if API value is 1
    //     let isTile = false;
    //     let isRack = false;
    //     let isObject = false;
    ...
    //     }
    //   } else {
    //     console.log("API response is not 1, not showing any info.");
    //     hideServerInfo();
    //     hideTileInfo();
    //     hideHVACInfo();
    //   }
    // };
    // let highlightedObject = null; // Ensure highlightedObject is defined outside the function
